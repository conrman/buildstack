...
window.showPOIDetail = function(marker) {
	//Open up the window!
	if (openWindow) {
		openWindow.setIcon(templateDirectory + '/assets/images/icon_map_marker_' + openWindow.POI.category + '.png');
		openWindow.infowindow.close();
	}
	
	marker.setIcon(templateDirectory + '/assets/images/icon_map_marker_' + marker.POI.category + '_over.png');
...
window.drawPoint = function(POI) {	
	...
	var windowString = '<div class="pointer-box"><a class="pointer" href="#"></a><div class="popup"><a class="btn-close" href="javascript:;">close x</a><h2 class="title">' + POI.name + '</h2><p><a target="_blank" href="http://www.google.com/maps/place/' + POI.address + '#">Directions</a><a target="_blank" href="' + POI.website + '">Website</a></p></div></div>';
	...
	var pointerIcon = templateDirectory+'/assets/images/icon_map_marker_' + POI.category + '.png';
